...
$filtros_query = " WHERE descricao LIKE '%$letra%' AND status = 1 ";
...
$dados = DBRead('', 'tb_patrimonio_item', $filtros_query, "COUNT(*) AS 'num_registros'");
...
// INICIO DO CONTEÚDOs
//
$dados = DBRead('', 'tb_patrimonio_item', $filtros_query . " ORDER BY id_patrimonio_item DESC LIMIT $inicio,$maximo");
if (!$dados) {
	...
	echo "<div class='table-responsive'>";
		echo "<table class='table table-hover' style='font-size: 14px;'>";
			...
			foreach ($dados as $conteudo) {
				...
				$id_patrimonio_item = $conteudo['id_patrimonio_item'];
				$descricao = $conteudo['descricao'];
				
				echo "<tr>";
				 	echo "<td>$id_patrimonio_item</td>";
					echo "<td>$descricao</td>";
					echo "<td class=\"text-center\"><a href='/api/iframe?token=<?php echo $request->token ?>&view=patrimonio-item-form&alterar=$id_patrimonio_item' title='Alterar'><i class='fa fa-pencil'></i></a></td>";
