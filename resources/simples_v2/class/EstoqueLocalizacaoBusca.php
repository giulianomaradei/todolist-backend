...
$dados = DBRead('', 'tb_estoque_localizacao', $filtros_query, "COUNT(*) AS 'num_registros'");
...
// INICIO DO CONTEÚDOs
//
$dados = DBRead('', 'tb_estoque_localizacao', $filtros_query . " ORDER BY nome ASC LIMIT $inicio,$maximo");
if (!$dados) {
	...
	echo "<div class='table-responsive'>";
		echo "<table class='table table-hover' style='font-size: 14px;'>";
			...
			foreach ($dados as $conteudo) {
				...
				$id_estoque_localizacao = $conteudo['id_estoque_localizacao'];
				$nome = $conteudo['nome'];
				
				echo "<tr>";
				 	echo "<td>$id_estoque_localizacao</td>";
					echo "<td>$nome</td>";
					echo "<td class=\"text-center\"><a href='/api/iframe?token=<?php echo $request->token ?>&view=estoque-localizacao-form&alterar=$id_estoque_localizacao' title='Alterar'><i class='fa fa-pencil'></i></a></td>";
