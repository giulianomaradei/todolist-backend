...
$marca = addslashes($parametros['marca']);

if($marca){
    $filtro_marca = " AND a.id_catalogo_equipamento_marca = '".$marca."'";
}
// Informações da query
$filtros_query  = "INNER JOIN tb_catalogo_equipamento_marca b ON a.id_catalogo_equipamento_marca = b.id_catalogo_equipamento_marca WHERE a.modelo LIKE '%".$letra."%' $filtro_marca ORDER BY a.modelo ASC";
...
$dados = DBRead('','tb_catalogo_equipamento a',$filtros_query,"COUNT(*) AS 'num_registros'");
...
// INICIO DO CONTEÚDO
// 
$dados = DBRead('', 'tb_catalogo_equipamento a',$filtros_query." LIMIT $inicio,$maximo");
if (!$dados) {
    ...
    echo "<thead>";
    echo "<tr>";
        echo "<th class=\"col-md-4\">Marca</th>";
        echo "<th class=\"col-md-4\">Modelo</th>";
    ...
    foreach ($dados as $conteudo) {
        $id = $conteudo['id_catalogo_equipamento'];
        ...
        echo "<tr>";    
            ...
            if(!$dados){
                echo "<td class=\"text-center\"><a href='/api/iframe?token=<?php echo $request->token ?>&view=catalogo-equipamento-form&alterar=$id' title='Alterar'><i class='fa fa-pencil'></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"class/CatalogoEquipamento.php?excluir=$id\" title='Excluir' onclick=\"if (!confirm('Excluir ".addslashes($nome)."?')) { return false; } else { modalAguarde(); }\"><i class='fa fa-trash' style='color:#b92c28;'></i></a></td>";
            }else{
                echo "<td class=\"text-center\"><a href='/api/iframe?token=<?php echo $request->token ?>&view=catalogo-equipamento-form&alterar=$id' title='Alterar'><i class='fa fa-pencil'></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>";
            }
