...
$dados = DBRead('','tb_inventario_software',$filtros_query,"COUNT(*) AS 'num_registros'");
...
// INICIO DO CONTEÚDO
// 
$dados = DBRead('', 'tb_inventario_software',$filtros_query." LIMIT $inicio,$maximo");
if (!$dados) {
        ...
        echo "<table class='table table-hover' style='font-size: 14px;'>";
            echo "<thead>";
                echo "<tr>";
                    ...
                    echo "<th class=\"col-md-10\">Observação</th>";
                    echo "<th class=\"col-md-2 text-center\">Opções</th>";
                echo "</tr>";
            echo "</thead>";
        echo "<tbody>";
        foreach ($dados as $conteudo) {
            $id = $conteudo['id_inventario_software'];
            $nome = $conteudo['nome'];
            ...
            echo "<tr>";
                ...
                echo "<td class=\"text-center\"><a href='/api/iframe?token=<?php echo $request->token ?>&view=inventario-software-form&alterar=$id' title='Alterar'><i class='fa fa-pencil'></i></a>".$status."</td>";
            echo "</tr>";
        }
            echo "</tbody>";
        echo "</table>";
