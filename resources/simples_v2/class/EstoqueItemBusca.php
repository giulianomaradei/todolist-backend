...
$filtros_query  = "WHERE nome LIKE '%$letra%' OR informacao_adicional LIKE '%$letra%' ";
...
$dados = DBRead('','tb_estoque_item',$filtros_query,"COUNT(*) AS 'num_registros'");
...
// INICIO DO CONTEÚDO
// 
$dados = DBRead('','tb_estoque_item',$filtros_query." ORDER BY nome ASC LIMIT $inicio,$maximo");
if (!$dados) {
    ...
    echo "<tr style='vertical-align: middle;'>";
        ...
        echo "<th class=\"col-md-3\">Informação Adicional</th>";
        echo "<th class=\"col-md-1\">Quantidade</th>";
        echo "<th class=\"col-md-1\">Quantidade Mínima</th>";
        echo "<th class=\"col-md-1\">Valor Unitário</th>";
        echo "<th class=\"col-md-1 text-center\">Opções</th>";
    echo "</tr>";
    echo "</thead>";
    echo "<tbody>";
    foreach ($dados as $conteudo) {
        $id = $conteudo['id_estoque_item'];
        $nome = $conteudo['nome'];
        $quantidade_minima = $conteudo['quantidade_minima'];
        ...
        $valor_unitario = converteMoeda($conteudo['valor_unitario'], "moeda");
        ...
        echo $td_quantidade;
        echo "<td style='vertical-align: middle;'>$quantidade_minima</td>";
        echo "<td style='vertical-align: middle;'>$valor_unitario</td>";
        echo "<td style='vertical-align: middle;' class=\"text-center\"><a href='/api/iframe?token=<?php echo $request->token ?>&view=estoque-item-form&alterar=$id' title='Alterar'><i class='fa fa-pencil'></i></a></td>";
        echo "</tr>";
    }
    echo "</tbody>";
    echo "</table>";
