...
$dados = DBRead('','tb_link_acesso',$filtros_query,"COUNT(*) AS 'num_registros'");
...
// INICIO DO CONTEÚDO
// 
$dados = DBRead('', 'tb_link_acesso',$filtros_query." LIMIT $inicio,$maximo");
if (!$dados) {
        ...
        echo "<table class='table table-hover' style='font-size: 14px;'>";
            echo "<thead>";
                echo "<tr>";
                    ...
                    echo "<th class=\"col-md-2\">Usuario</th>";
                    echo "<th class=\"col-md-2\">Senha</th>";
                    echo "<th class=\"col-md-3\">IP</th>";
                    echo "<th class=\"col-md-2 text-center\">Opções</th>";
                echo "</tr>";
            echo "</thead>";
        echo "<tbody>";
        foreach ($dados as $conteudo) {
            $id = $conteudo['id_link_acesso'];
            $nome = $conteudo['nome'];
            $usuario = $conteudo['user'];
            ...
            echo "<tr>";
                ...
                echo "<td> $senha</td>";
                echo "<td> $ip</td>";
                echo "<td class=\"text-center\"><a href='/api/iframe?token=<?php echo $request->token ?>&view=troca-link-form&alterar=$id' title='Alterar'><i class='fa fa-pencil'></i></a></td>";
            echo "</tr>";
        }
            echo "</tbody>";
        echo "</table>";
