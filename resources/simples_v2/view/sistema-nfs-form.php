        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading clearfix">
                    <h3 class="panel-title text-left pull-left">Dados da NFS-e #<?=$id_nfs;?></h3>
                </div>
                <form method="post" action="/api/ajax?class=SistemaNfs.php" id="parametro_form" style="margin-bottom: 0;">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control input-sm" name="status" id="status" onchange="call_busca_ajax();">
                                        <option value="autorizada" <?php if($status == 'autorizada'){ echo 'selected';}?>>autorizada</option>
                                        <option value="cancelada" <?php if($status == 'cancelada'){ echo 'selected';}?>>cancelada</option>
                                        <option value="nao enviado" <?php if($status == 'nao enviado'){ echo 'selected';}?>>nao enviado</option>
                                        <option value="negada" <?php if($status == 'negada'){ echo 'selected';}?>>negada</option>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="panel-footer">
                        <div class="row">
                            <div class="col-md-12" style="text-align: center">
                                <input type="hidden" id="operacao" value="<?= $id_nfs; ?>" name="sistema_alterar"/>
