        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading clearfix">
                    ...
                    <div class="panel-title text-right pull-right"><a href="/api/iframe?token=<?php echo $request->token ?>&view=horario-form"><button class="btn btn-xs btn-primary"><i class="fa fa-plus"></i> Novo</button></a></div>
                </div>
...
<script>
    function call_busca_ajax(pagina){
        ...
        busca_ajax('<?= $request->token ?>' , 'HorarioBusca', 'resultado_busca', parametros);
    }
