        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading clearfix">
                    <h3 class="panel-title text-left pull-left"><?php echo $tituloPainel.' Quantidade de Clientes no Faturamento de Call Suporte: <strong>'.$nome.'</strong>'; ?></h3>
                </div>
