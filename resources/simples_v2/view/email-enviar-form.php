...
$tipo_pessoa = (!empty($_POST['tipo_pessoa'])) ? $_POST['tipo_pessoa'] : '';
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default">
                ...
                <form method="post" action="/api/ajax?class=EmailEnviar.php" id="enviar_email" style="margin-bottom: 0;">
		            <input type="hidden" name="token" value="<?php echo $request->token ?>">
                    <input type="hidden" id="selecionar" name="tipo_pessoa" value="<?=$tipo_pessoa?>"/>
                    <?php

                		foreach ($selecionar as $conteudo) {
                    		echo '<input type="hidden" id="selecionar" name="selecionar[]" value="'.$conteudo.'"/>';
                		}
                    ...
                    <div class="panel-footer">
                        <div class="row">
                            <div class="col-md-12" style="text-align: center">
                                <input type="hidden" id="operacao" name="enviar_email" value="abc"/>
...
<script>
    ...
    $(document).on('submit', '#enviar_email', function () {
