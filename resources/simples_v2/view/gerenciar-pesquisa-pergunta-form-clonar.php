...
$id_pergunta_pesquisa = $_GET['id_pergunta_pesquisa'];

$perguntas = DBRead('', 'tb_resposta_pesquisa a', "inner join tb_pergunta_pesquisa b on a.id_pergunta_pesquisa = b.id_pergunta_pesquisa where a.id_pergunta_pesquisa = '".$id_pergunta_pesquisa."'", "a.descricao AS descricao_resposta, a.posicao AS posicao_resposta, a.finalizar_pesquisa, a.id_pergunta_pesquisa, b.descricao AS descricao_pergunta, b.posicao AS posicao_pergunta, b.resposta_pai, b.observacao, b.id_pesquisa, b.id_tipo_resposta_pesquisa, b.status");
$descricao_pergunta = $perguntas[0]['descricao_pergunta'];
$posicao_pergunta = $perguntas[0]['posicao_pergunta'];
$tipo_resposta = $perguntas[0]['id_tipo_resposta_pesquisa'];
$observacao = $perguntas[0]['observacao'];
$id_pesquisa = $perguntas[0]['id_pesquisa'];
?>
        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading clearfix">
                    <h3 class="panel-title text-left pull-left"><?= $tituloPainel ?> perguntas:</h3>
                </div>
                <form method="post" action="/api/ajax?class=PesquisaPergunta.php" id="pesquisa_form" style="margin-bottom: 0;">
                    ...
                    <input type='hidden' value='<?=$id_pergunta_pesquisa?>' name='pergunta_a_ser_clonada' />
                    <div class="panel-body" style="padding-bottom: 0;">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>*Descrição:</label>
                                    <textarea name="descricao" id="descricao" autofocus class="form-control" required><?= $descricao_pergunta; ?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>*Posição:</label>
                                    <input name="posicao" id="posicao" type="number" min="1" class="form-control input-sm" value="<?= $posicao_pergunta; ?>" autocomplete="off" required>
                                </div>
                            </div>
                                ...
                                <select class="form-control input-sm" name="id_tipo_resposta_pesquisa" id="id_tipo_resposta_pesquisa">
                                    ...
                                    //$id_tipo_resposta_pesquisa = $tipos_selecionado[0]['id_tipo_resposta_pesquisa'];
                                        ...
                                        foreach($tipos as $tipo){
                                            $selected = $tipo_resposta == $tipo['id_tipo_resposta_pesquisa'] ? "selected" : "";
                                        ...
                                        <div class="row">
                                            <?php
                                                ...
                                                if($tipo_resposta == 4){
                                                    ...
                                                    $escala_de = $perguntas[0]['posicao'];
                                                    $invertido = array_reverse($perguntas);
                                    ...
                                    <table class="table table-bordered" style='font-size: 14px;'>
                                        ...
                                        <tbody>
                                            ...
                                            //if($operacao == "alterar"){
                                                ...
                                                foreach($perguntas as $dado){
                                                    echo "<tr class='linha_resposta'>";
                                                        echo "<input type='hidden' name='id_resposta_pesquisa[]' value='".$dado['id_resposta_pesquisa']."' />";
                                                        echo "<td><textarea name='descricao_resposta[]' class='form-control'>".$dado['descricao_resposta']."</textarea></td>";
                                                        echo "<td><input type='number' min='0' name='posicao_resposta[]' class='form-control posicao_resposta' value='".$dado['posicao_resposta']."' /></td>";
