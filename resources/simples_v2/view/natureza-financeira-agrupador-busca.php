        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading clearfix">
                    <h3 class="panel-title text-left pull-left" style="margin-top: 2px;">Agrupadores de Naturezas Financeiras:</h3>
                    <div class="panel-title text-right pull-right">
                        <a href="/api/iframe?token=<?php echo $request->token ?>&view=natureza-financeira-agrupador-form"><button class="btn btn-xs btn-primary"><i class="fa fa-plus"></i> Novo</button></a>
                    </div>
                </div>
...
<script>
    ...
    function call_busca_ajax(pagina){
        ...
        busca_ajax('<?= $request->token ?>' , 'NaturezaFinanceiraAgrupadorBusca', 'resultado_busca', parametros);
    }
