...
if (isset($_GET['alterar'])) {
    ...
    $obs_alteracao = $dados[0]['obs_alteracao'];
    ...
    echo '<div class="container-fluid text-center">
        <div class="alert alert-warning">
            <i class="fa fa-exclamation-triangle" aria-hidden="true"></i> Ops! Você não selecionou nenhu boleto!
        </div>
    </div>';
    die();
}
    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <form method="post" action="/api/ajax?class=SistemaBoleto.php" id="parametro_form" style="margin-bottom: 0;">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control input-sm" name="situacao" id="situacao">
                                        <option value="ALTERACAO VENCIMENTO PENDENTE" <?php if($situacao == 'ALTERACAO VENCIMENTO PENDENTE'){ echo 'selected';}?>>ALTERACAO VENCIMENTO PENDENTE</option>
                                        <option value="BAIXA PENDENTE" <?php if($situacao == 'BAIXA PENDENTE'){ echo 'selected';}?>>BAIXA PENDENTE</option>
                                        <option value="BAIXADO" <?php if($situacao == 'BAIXADO'){ echo 'selected';}?>>BAIXADO</option>
                                        <option value="EMITIDO" <?php if($situacao == 'EMITIDO'){ echo 'selected';}?>>EMITIDO</option>
                                        <option value="FALHA" <?php if($situacao == 'FALHA'){ echo 'selected';}?>>FALHA</option>
                                        <option value="LIQUIDADO" <?php if($situacao == 'LIQUIDADO'){ echo 'selected';}?>>LIQUIDADO</option>
                                        <option value="REGISTRADO" <?php if($situacao == 'REGISTRADO'){ echo 'selected';}?>>REGISTRADO</option>
                                        <option value="REJEITADO" <?php if($situacao == 'REJEITADO'){ echo 'selected';}?>>REJEITADO</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-9">
                                <label>Observação de Alteração:</label>
                                <textarea class="form-control" rows="2" name="obs_alteracao"><?=$obs_alteracao?></textarea>
                                <br>
                            </div>
                        </div>
                        <hr>
                    ...
                    <div class="panel-footer">
                        <div class="row">
                            <div class="col-md-12" style="text-align: center">
                                <input type="hidden" id="operacao" value="<?= $id_boleto; ?>" name="sistema_alterar"/>
                                <button class="btn btn-primary" name="salvar" id="ok" type="submit"><i class="fa fa-check"></i> Alterar</button>
                            </div>
                        </div>
                    </div>
                </form>
