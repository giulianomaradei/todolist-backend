        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default">
                <div class="panel-heading clearfix">
                    <h3 class="panel-title text-left pull-left">Clonar Conta a Receber:</h3>
                </div>
                <form method="post" action="/api/ajax?class=ContaReceber.php" id="clonar_conta_receber" style="margin-bottom: 0;">
		            <input type="hidden" name="token" value="<?php echo $request->token ?>">
                    <input type="hidden" id="id_conta_receber" name="id_conta_receber" value="<?=$selecionar[0]?>"/>
                    <div class="panel-body" style="padding-bottom: 0;">
                        ...
                        <div class="row">
                            <div class="col-md-6" id="div_valor_total">
                                <div class="form-group">
                                    <label>Valor da Conta a Receber:</label>
                    ...
                    <div class="panel-footer">
                        <div class="row">
                            <div class="col-md-12" style="text-align: center">
                                <input type="hidden" id="operacao" value="1" name="clonar_conta_receber"/>
...
<script>
    ...
    $(document).on('submit', '#clonar_conta_receber', function () {
