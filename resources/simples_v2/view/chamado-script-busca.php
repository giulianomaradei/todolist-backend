        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading clearfix">
                    <h3 class="panel-title text-left pull-left" style="margin-top: 2px;">Categorias:</h3>
                    <div class="panel-title text-right pull-right"><a href="/api/iframe?token=<?php echo $request->token ?>&view=chamado-script-form"><button class="btn btn-xs btn-primary"><i class="fa fa-plus"></i> Novo</button></a></div>
                </div>
...
<script>
    function call_busca_ajax(pagina){
        ...
        busca_ajax('<?= $request->token ?>' , 'ChamadoScriptBusca', 'resultado_busca', parametros);
    }
