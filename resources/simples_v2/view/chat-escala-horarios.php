...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-4 col-md-offset-4">
            <?php
                isset($id_usuario = $_SESSION['id_usuario']) ? $id_usuario : '';
                $dados = DBRead('', 'tb_usuario', "WHERE id_usuario = '$id_usuario'");
                $perfil_sistema = $dados[0]['id_perfil_sistema'];           
            ?>
            <div class="panel panel-default">
                <div class="panel-heading clearfix">
                    <h3 class="panel-title text-left pull-left" style="margin-top: 2px;">Horários de Chat:</h3>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group has-feedback">
                                ...
                                <input class="form-control input-sm" type="text" name="titulo" id="titulo" onKeyUp="call_busca_ajax();" placeholder="Informe o nome..." autocomplete="off" autofocus>
...
<script>
    function call_busca_ajax(pagina){
        ...
        busca_ajax('<?= $request->token ?>' , 'ChatEscalaBuscaHorarios', 'resultado_busca', parametros);
    }
