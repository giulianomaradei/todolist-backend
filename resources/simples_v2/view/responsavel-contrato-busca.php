        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading clearfix">
                    <h3 class="panel-title text-left pull-left" style="margin-top: 2px;">Responsáveis Técnicos e pelos Relacionamentos:</h3>
                </div>
...
<script>
    function call_busca_ajax(pagina){
        ...
        busca_ajax('<?= $request->token ?>' , 'ResponsavelContratoBusca', 'resultado_busca', parametros);
    }
