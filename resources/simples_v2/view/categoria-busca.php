        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading clearfix">
                    ...
                    <div class="panel-title text-right pull-right"><a href="/api/iframe?token=<?php echo $request->token ?>&view=categoria-form"><button class="btn btn-xs btn-primary"><i class="fa fa-plus"></i> Novo</button></a></div>
                </div>
...
<script>
    function call_busca_ajax(pagina){
        ...
        busca_ajax('<?= $request->token ?>' , 'CategoriaBusca', 'resultado_busca', parametros);
    }
