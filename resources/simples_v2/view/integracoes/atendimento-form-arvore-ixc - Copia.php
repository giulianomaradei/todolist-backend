                ...
                success: function(data) {
                    ...
                    $.each(data, function(i) {
                        ...
                        if (data[i].codigo_campo == 'prioridade') {
                            $("#prioridade").val(data[i].value_default);
                        }
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        <div class='col-md-6' style="padding-bottom: 15px;">
                            ...
                            <span id="alerta" class="text-danger">Setor obrigatório!</span>
                        </div>
                        <div class='col-md-6' style="padding-bottom: 20px;">
                            ...
                            <span id="alerta" class="text-danger">Técnico responsável obrigatório!</span>
                        </div>
                    </div>
                    `;
                        } else {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        <!--<div class='col-md-6' style="padding-bottom: 15px;">
                            ...
                            <span id="alerta" class="text-danger">O campo Departamento é obrigatório!</span>
                        </div>
